...
DROP TABLE IF EXISTS public.pelatihan CASCADE;
...
-- Create enum for jacket sizes (check if exists first)
DO $$ BEGIN
...
CREATE POLICY "Authorized users can view peserta"
...
CREATE POLICY "Authorized users can view pembayaran"
...
CREATE POLICY "Authorized users can view pengeluaran"
